...
export const BatchDefaults: core.serialization.ObjectSchema<
    serializers.BatchDefaults.Raw,
    TwelvelabsApi.BatchDefaults
...
export declare namespace BatchDefaults {
