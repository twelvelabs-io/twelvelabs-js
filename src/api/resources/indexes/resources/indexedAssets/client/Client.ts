...
export class IndexedAssets {
    ...
    public async listByAsset(
        ...
        requestOptions?: IndexedAssets.RequestOptions,
    ): Promise<core.Page<TwelvelabsApi.IndexedAssetSummary>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: TwelvelabsApi.indexes.IndexedAssetsListByAssetRequest,
            ): Promise<core.WithRawResponse<TwelvelabsApi.indexes.IndexedAssetsListByAssetResponse>> => {
                ...
                const _response = await core.fetcher({
                    url: urlJoin(
                        (await core.Supplier.get(this._options.baseUrl)) ??
                            (await core.Supplier.get(this._options.environment)) ??
                            environments.TwelvelabsApiEnvironment.Default,
                        `assets/${encodeURIComponent(assetId)}/indexed-assets`,
                    ),
                    method: "GET",
                    headers: {
                        "X-Fern-Language": "JavaScript",
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.TwelvelabsApiTimeoutError(
                            "Timeout exceeded when calling GET /assets/{asset_id}/indexed-assets.",
                        );
                    case "unknown":
                        throw new errors.TwelvelabsApiError({
                            message: _response.error.errorMessage,
